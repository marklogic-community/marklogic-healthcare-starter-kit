...
loadTestFileToStagingWithPerms("provider1.json", "/provider1.json", ["testProvider", "ProviderIngest"])
loadTestFileToStagingWithPerms("sanction1.json", "/sanction1.json", ["testSanction", "SanctionIngest"])
