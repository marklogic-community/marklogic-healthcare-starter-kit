...
const assertions = [
  ...
  testRedactionFunction(redactionFunctions.redactText, 'test string', { charset: 'abcdefghijklmnopqrstuvwxyz' }, 'vjau ztuowi'),
  testRedactionFunction(redactionFunctions.redactText, 'TEST STRING', { caseInsensitive: true }, 'vj0u ztuowi'),
  ...
  ...testRedaction(test.getTestFile('patientWithMultipleIdentifiers.json'), 'member-redaction', {
    ...
    // '//HumanName/family': '',
    // '//HumanName/given': '',
    '//id': '58df2064-b7a9-7b8f-3400-1cbd5532dfd8',
    '//identifier__dl': 'ueha9d1ab',
    '//identifier__passport': 'z8f9cg09e6',
